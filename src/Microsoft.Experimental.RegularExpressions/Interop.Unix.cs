...
namespace Microsoft.Experimental.RegularExpressions
{
    ...
    internal partial class Interop
    {
        ...
        [DllImport("libpcre2-16", CharSet = CharSet.Ansi, EntryPoint = "pcre2_compile_16")]
        ...
        [DllImport("libpcre2-16", EntryPoint = "pcre2_jit_compile_16")]
        ...
        [DllImport("libpcre2-16", CharSet = CharSet.Unicode, EntryPoint = "pcre2_get_error_message_16")]
        ...
        [DllImport("libpcre2-16", CharSet = CharSet.Unicode, EntryPoint = "pcre2_substitute_16")]
        ...
        [DllImport("libpcre2-16", CharSet = CharSet.Ansi, EntryPoint = "pcre2_match_data_create_from_pattern_16")]
        ...
        [DllImport("libpcre2-16", CharSet = CharSet.Ansi, EntryPoint = "pcre2_match_16")]
        ...
        [DllImport("libpcre2-16", CharSet = CharSet.Ansi, EntryPoint = "pcre2_get_ovector_count_16")]
        internal static unsafe extern int pcre2_get_ovector_count(IntPtr match_data);

        // PCRE2_SIZE* pcre2_get_ovector_pointer(pcre2_match_data* match_data);
        [DllImport("libpcre2-16", CharSet = CharSet.Ansi, EntryPoint = "pcre2_get_ovector_pointer_16")]
        internal static unsafe extern IntPtr pcre2_get_ovector_pointer(IntPtr match_data);

        // void pcre2_match_data_free(pcre2_match_data *match_data);
        [DllImport("libpcre2-16", CharSet = CharSet.Ansi, EntryPoint = "pcre2_match_data_free_16")]
