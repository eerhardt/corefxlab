...
namespace Microsoft.Experimental.RegularExpressions.Tests
{
    public class RegexReplaceTests
    {
        public static IEnumerable<object[]> Replace_String_TestData()
        {
            //string pattern, string input, string replacement, RegexOptions options, int count, int start, string expected)
            ...
            // PCRE only supports replacement counts of 0, 1, and all
            ...
            //for (int i = 0; i < 200; i++)
            //    input += "abcde";
            //yield return new object[] { pattern, input, "$250", RegexOptions.None, input.Length, 0, "e" };
            ...
            // PCRE does not support $` $+ $_ $'  ...  "invalid replacement string"
            ...
            yield return new object[] { @"(d)(o)(g)(\s)(c)(a)(t)(\s)(h)(a)(s)", "My dog cat has fleas.", "$01$02$03$04$05$06$07$08$09$10$11", RegexOptions.IgnoreCase | RegexOptions.Multiline, 21, 0, "My dog cat has fleas." };
            yield return new object[] { @"(d)(o)(g)(\s)(c)(a)(t)(\s)(h)(a)(s)", "My dog cat has fleas.", "$05$06$07$04$01$02$03$08$09$10$11", RegexOptions.IgnoreCase | RegexOptions.Multiline, 21, 0, "My cat dog has fleas." };
